            ...
            <div class="table-responsive">
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td class="text-center"><?php echo sql2date($formData['document_date']);?></td>
                    </tr>
                    </tbody>
                </table>
            </div>
                    ...
                    <div class="table-bordered">
                        <table class="table mb-0">
                            ...
                            <tr class="table-info">
                                ...
                                <td class="col-md-3 text-center border-top-0"><strong>Delivery Date</strong></td>
                                <td class="col-2 text-right border-top-0"><strong>Qty Unit</strong></td>
