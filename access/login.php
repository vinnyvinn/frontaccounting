...
function defaultCompany()
{
	...
	$title = $login_timeout ? _('Authorization timeout') : _("Login");
	...
	echo "<table class='titletext'><tr><td>WizERP</td></tr></table>\n";
	...
	if (!$login_timeout) { // FA logo
    	echo "<a target='_blank' href='".$SysPrefs->power_url."'><img src='$path_to_root/themes/$def_theme/images/erp.png' alt='WizERP' height='50' onload='fixPNG(this)' border='0' ></a>";
	} else { 
